...
from robot.data import number_class as Num
from robot.data.number_class import okc_number_dict
...
# read wild_res.json
wild_res_json_data_path = util.get_ini_data(config.conf_path, section="path", section_item="wild_res_json")
